...
void tau_set_interrupt_interval(struct timeval value)
{
} 
...
void tau_set_interrupt_interval_(struct timeval value)
{
} 
...
void tau_set_interrupt_interval__(struct timeval value)
{
}
