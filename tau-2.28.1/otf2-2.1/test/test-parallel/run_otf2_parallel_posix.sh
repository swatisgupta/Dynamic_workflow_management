...
do
    ...
    do
        ...
        tests=$((tests + 1))
        writer_cmd="./test-writer -nt $w $t 1 $l"
        ...
        do
            ...
            do
                ...
                test ${V-0} -eq 1 && echo "$w.$l.$n - Reading with $r rank(s) |{$s}| out of $i location(s) in $w rank(s) (w/o subgroups; w/o global-reader hint): $reader_cmd"
                ...
                test ${V-0} -eq 1 && echo "$w.$l.$n - Reading with $r rank(s) |{$s}| out of $i location(s) in $w rank(s) (w/ subgroups; w/o global-reader hint): $reader_cmd"
                if $VALGRIND $reader_cmd
                then
                    successes=$((successes + 1))
                else
                ...
                test ${V-0} -eq 1 && echo "$w.$l.$n - Reading with $r rank(s) |{$s}| out of $i location(s) in $w rank(s) (w/ serial; w/o global-reader hint): $reader_cmd"
                if $VALGRIND $reader_cmd
                then
                    successes=$((successes + 1))
                else
                ...
                test ${V-0} -eq 1 && echo "$w.$l.$n - Reading with $r rank(s) |{$s}| out of $i location(s) in $w rank(s) (w/o subgroups; w/ global-reader hint): $reader_cmd"
                if $VALGRIND $reader_cmd
                then
                    successes=$((successes + 1))
                else
                ...
                test ${V-0} -eq 1 && echo "$w.$l.$n - Reading with $r rank(s) |{$s}| out of $i location(s) in $w rank(s) (w/ subgroups; w/ global-reader hint): $reader_cmd"
                if $VALGRIND $reader_cmd
                then
                    successes=$((successes + 1))
                else
                ...
                test ${V-0} -eq 1 && echo "$w.$l.$n - Reading with $r rank(s) |{$s}| out of $i location(s) in $w rank(s) (w/ serial; w/ global-reader hint): $reader_cmd"
                if $VALGRIND $reader_cmd
                then
                    successes=$((successes + 1))
                else
        ...
        t="$t-nold"
        tests=$((tests + 1))
        writer_cmd="./test-writer -nt $w $t 0 $l"
