...
do
    ...
    do
        ...
        do
            ...
            tests=$((tests + 1))
            n=$((n + 1))
            writer_cmd="./test-writer -nt $w $t 1 $l $f"
            ...
            do
                ...
                do
                    ...
                    test ${V-0} -eq 1 && echo "$w.$l.$n.$m - Reading with $r rank(s) |{$s}| out of $i location(s) out of $f files (w/ sub-groups; w/o global-reader hint): $reader_cmd"
                    if $VALGRIND $reader_cmd
                    then
                        successes=$((successes + 1))
                    else
                    ...
                    test ${V-0} -eq 1 && echo "$w.$l.$n.$m - Reading with $r rank(s) |{$s}| out of $i location(s) out of $f files (w/ serial; w/o global-reader hint): $reader_cmd"
                    if $VALGRIND $reader_cmd
                    then
                        successes=$((successes + 1))
                    else
                    ...
                    test ${V-0} -eq 1 && echo "$w.$l.$n.$m - Reading with $r rank(s) |{$s}| out of $i location(s) out of $f files (w/o sub-groups; w/ global-reader hint): $reader_cmd"
                    if $VALGRIND $reader_cmd
                    then
                        successes=$((successes + 1))
                    else
                    ...
                    test ${V-0} -eq 1 && echo "$w.$l.$n.$m - Reading with $r rank(s) |{$s}| out of $i location(s) out of $f files (w/ sub-groups; w/ global-reader hint): $reader_cmd"
                    if $VALGRIND $reader_cmd
                    then
                        successes=$((successes + 1))
                    else
                    ...
                    test ${V-0} -eq 1 && echo "$w.$l.$n.$m - Reading with $r rank(s) |{$s}| out of $i location(s) out of $f files (w/ serial; w/ global-reader hint): $reader_cmd"
                    if $VALGRIND $reader_cmd
                    then
                        successes=$((successes + 1))
                    else
            ...
            t="$t-nold"
            tests=$((tests + 1))
            writer_cmd="./test-writer -nt $w $t 0 1 $f"
